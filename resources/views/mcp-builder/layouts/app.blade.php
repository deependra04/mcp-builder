...
<body class="mcp-builder">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mcp-builder-navbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('mcp-builder.dashboard') }}">MCP Builder</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mcp-builder-navbar">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="mcp-builder-navbar">
    ...
    <main class="container-fluid mt-4">
        ...
        <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
            <div id="mcp-builder-toast-container"></div>
        </div>
        ...
        @if(session('success'))
            ...
            @endphp
            <div id="{{ $toastId }}" class="mcp-builder-toast toast align-items-center bg-success text-white border-0" 
        ...
        @if(session('error'))
            ...
            @endphp
            <div id="{{ $errorToastId }}" class="mcp-builder-toast toast align-items-center bg-danger text-white border-0" 
                 role="alert" aria-live="assertive" aria-atomic="true"
            ...
            @if(session('error_suggestions'))
                <div class="mcp-builder-alert alert alert-warning alert-dismissible fade show" role="alert">
    ...
    {{-- Compiled TypeScript files will be loaded here --}}
